...
public class L11 extends SuperObject {
    ...
    private int ifexaustoronof;
    private int ifesteiraind;
    private int ifesteiraset;
    private int b1tempchillerind;
    private int b1tempchillerset;
    private int b1reserset;
    private int banheira2onof;
    private int banheira2bombatanqueonof;
    private int b2tempchillerind;
    private int b2tempchillerset;
    private int banheira2reservatorioind;
    private int b2reserset;
    private int banheira3onof;
    private int banheira3bombatanqueonof;
    private int b3tempchillerind;
    private int b3tempchillerset;
    private int banheira3reservatorioind;
    private int b3reserset;
    private int puller2velocidadeind;
    private int puller2velocidadeset;
    private int puller2inversoronof;
    private int puller3velocidadeind;
    private int puller3velocidadeset;
    private int puller3inversoronof;
    private int ifventilador;
    private int cortvelocidade;
    private int comprimento;
    private int cortserrarecuo;
    private int cortserraavanco;
    ...
    public L11() {
        ...
        b1reserset = 0;
        banheira2onof = 0;
        banheira2bombatanqueonof = 0;
        b2tempchillerind = 0;
        b2tempchillerset = 0;
        banheira2reservatorioind = 0;
        b2reserset = 0;
        banheira3onof = 0;
        banheira3bombatanqueonof = 0;
        b3tempchillerind = 0;
        b3tempchillerset = 0;
        banheira3reservatorioind = 0;
        b3reserset = 0;
        puller2velocidadeind = 0;
        puller2velocidadeset = 0;
        puller2inversoronof = 0;
        puller3velocidadeind = 0;
        puller3velocidadeset = 0;
        puller3inversoronof = 0;
        ifventilador = 0;
        cortvelocidade = 0;
        comprimento = 0;
        cortserrarecuo = 0;
    ...
    public int getIfexaustoronof() {
        return ifexaustoronof;
    }

    public void setIfexaustoronof(int ifexaustoronof) {
        this.ifexaustoronof = ifexaustoronof;
    }

    public int getIfesteiraind() {
        return ifesteiraind;
    }

    public void setIfesteiraind(int ifesteiraind) {
        this.ifesteiraind = ifesteiraind;
    }

    public int getIfesteiraset() {
        return ifesteiraset;
    }

    public void setIfesteiraset(int ifesteiraset) {
        this.ifesteiraset = ifesteiraset;
    }

    public int getB1tempchillerind() {
        return b1tempchillerind;
    }

    public void setB1tempchillerind(int b1tempchillerind) {
        this.b1tempchillerind = b1tempchillerind;
    }

    public int getB1tempchillerset() {
        return b1tempchillerset;
    }

    public void setB1tempchillerset(int b1tempchillerset) {
        this.b1tempchillerset = b1tempchillerset;
    }

    public int getB1reserset() {
        return b1reserset;
    }

    public void setB1reserset(int b1reserset) {
        this.b1reserset = b1reserset;
    }

    public int getBanheira2onof() {
        return banheira2onof;
    }

    public void setBanheira2onof(int banheira2onof) {
        this.banheira2onof = banheira2onof;
    }

    public int getBanheira2bombatanqueonof() {
        return banheira2bombatanqueonof;
    }

    public void setBanheira2bombatanqueonof(int banheira2bombatanqueonof) {
        this.banheira2bombatanqueonof = banheira2bombatanqueonof;
    }

    public int getB2tempchillerind() {
        return b2tempchillerind;
    }

    public void setB2tempchillerind(int b2tempchillerind) {
        this.b2tempchillerind = b2tempchillerind;
    }

    public int getB2tempchillerset() {
        return b2tempchillerset;
    }

    public void setB2tempchillerset(int b2tempchillerset) {
        this.b2tempchillerset = b2tempchillerset;
    }

    public int getBanheira2reservatorioind() {
        return banheira2reservatorioind;
    }

    public void setBanheira2reservatorioind(int banheira2reservatorioind) {
        this.banheira2reservatorioind = banheira2reservatorioind;
    }

    public int getB2reserset() {
        return b2reserset;
    }

    public void setB2reserset(int b2reserset) {
        this.b2reserset = b2reserset;
    }

    public int getBanheira3onof() {
        return banheira3onof;
    }

    public void setBanheira3onof(int banheira3onof) {
        this.banheira3onof = banheira3onof;
    }

    public int getBanheira3bombatanqueonof() {
        return banheira3bombatanqueonof;
    }

    public void setBanheira3bombatanqueonof(int banheira3bombatanqueonof) {
        this.banheira3bombatanqueonof = banheira3bombatanqueonof;
    }

    public int getB3tempchillerind() {
        return b3tempchillerind;
    }

    public void setB3tempchillerind(int b3tempchillerind) {
        this.b3tempchillerind = b3tempchillerind;
    }

    public int getB3tempchillerset() {
        return b3tempchillerset;
    }

    public void setB3tempchillerset(int b3tempchillerset) {
        this.b3tempchillerset = b3tempchillerset;
    }

    public int getBanheira3reservatorioind() {
        return banheira3reservatorioind;
    }

    public void setBanheira3reservatorioind(int banheira3reservatorioind) {
        this.banheira3reservatorioind = banheira3reservatorioind;
    }

    public int getB3reserset() {
        return b3reserset;
    }

    public void setB3reserset(int b3reserset) {
        this.b3reserset = b3reserset;
    }

    public int getPuller2velocidadeind() {
        return puller2velocidadeind;
    }

    public void setPuller2velocidadeind(int puller2velocidadeind) {
        this.puller2velocidadeind = puller2velocidadeind;
    }

    public int getPuller2velocidadeset() {
        return puller2velocidadeset;
    }

    public void setPuller2velocidadeset(int puller2velocidadeset) {
        this.puller2velocidadeset = puller2velocidadeset;
    }

    public int getPuller2inversoronof() {
        return puller2inversoronof;
    }

    public void setPuller2inversoronof(int puller2inversoronof) {
        this.puller2inversoronof = puller2inversoronof;
    }

    public int getPuller3velocidadeind() {
        return puller3velocidadeind;
    }

    public void setPuller3velocidadeind(int puller3velocidadeind) {
        this.puller3velocidadeind = puller3velocidadeind;
    }

    public int getPuller3velocidadeset() {
        return puller3velocidadeset;
    }

    public void setPuller3velocidadeset(int puller3velocidadeset) {
        this.puller3velocidadeset = puller3velocidadeset;
    }

    public int getPuller3inversoronof() {
        return puller3inversoronof;
    }

    public void setPuller3inversoronof(int puller3inversoronof) {
        this.puller3inversoronof = puller3inversoronof;
    }

    public int getIfventilador() {
        return ifventilador;
    }

    public void setIfventilador(int ifventilador) {
        this.ifventilador = ifventilador;
    }

    public int getCortvelocidade() {
        return cortvelocidade;
    }

    public void setCortvelocidade(int cortvelocidade) {
    ...
    public int getCortserrarecuo() {
        return cortserrarecuo;
    }

    public void setCortserrarecuo(int cortserrarecuo) {
        this.cortserrarecuo = cortserrarecuo;
    }

    public int getCortserraavanco() {
        return cortserraavanco;
    }

    public void setCortserraavanco(int cortserraavanco) {
