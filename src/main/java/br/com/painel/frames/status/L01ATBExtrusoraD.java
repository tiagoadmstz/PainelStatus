 ...
 * @author rsouza10
 */
public class L01ATBExtrusoraD extends javax.swing.JFrame {

    /**
     * Creates new form L11Extrusora
     */
    public L01ATBExtrusoraD() {
        initComponents();
            ...
            public void run() {
                try {
                    ...
                    String query1 = "SELECT TOP 1 (ExtD_IndInv1)as inv1ind,(ExtD_SetInv1)as inv1set, (Perfil)as perfil,"
                            ...
                            + "(ExtD_Amp) as extamp,(ExtD_Bar) as extbar,(ExtD_IndRpm) as extindrpm FROM L03 ORDER BY E3TimeStamp DESC";
        ...
        timer1.scheduleAtFixedRate(new TimerTask() {
            public void run() {
                try {
                    Class.forName(Auxiliar.AcessoBanco.getDriver());
                    Connection con = DriverManager.getConnection(Auxiliar.AcessoBanco.getUrl(), Auxiliar.AcessoBanco.getUser(), Auxiliar.AcessoBanco.getPass());
                    String query1 = "SELECT TOP 1 (ExtD_Corrente) as extamp,(ExtD_Pressao) as extbar,(ExtD_Rotacao) as extindrpm FROM L03_Criticos ORDER BY E3TimeStamp DESC";
                    Statement st = con.createStatement();
                    ResultSet rs = st.executeQuery(query1);
                    float extamp = 0f;
                    float extbar = 0f;
...
/////////////////////////////////////////////////////////////////////////////////////
        try {
            Class.forName(Auxiliar.AcessoBanco.getDriver());
            Connection con = DriverManager.getConnection(Auxiliar.AcessoBanco.getUrl(), Auxiliar.AcessoBanco.getUser(), Auxiliar.AcessoBanco.getPass());
            String query1 = "SELECT * FROM(SELECT ValueID, TemplateID, (Value) as valor1 FROM Receita03_ValueData WHERE ValueID = (SELECT ValueID FROM Receita03_ValueData WHERE Value = '" + lbperfil.getText() + "')) RECEITA WHERE TemplateID = '16'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(query1);
            float valor1 = 0f;
        ...
        try {
            Class.forName(Auxiliar.AcessoBanco.getDriver());
            Connection con = DriverManager.getConnection(Auxiliar.AcessoBanco.getUrl(), Auxiliar.AcessoBanco.getUser(), Auxiliar.AcessoBanco.getPass());
            String query1 = "SELECT * FROM(SELECT ValueID, TemplateID,(Value) as valor2 FROM Receita03_ValueData WHERE ValueID = (SELECT ValueID FROM Receita03_ValueData WHERE Value = '" + lbperfil.getText() + "')) RECEITA WHERE  TemplateID = '20'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(query1);
        ...
        try {
            Class.forName(Auxiliar.AcessoBanco.getDriver());
            Connection con = DriverManager.getConnection(Auxiliar.AcessoBanco.getUrl(), Auxiliar.AcessoBanco.getUser(), Auxiliar.AcessoBanco.getPass());
            String query1 = "SELECT * FROM(SELECT ValueID, TemplateID,(Value) as valor2 FROM Receita03_ValueData WHERE ValueID = (SELECT ValueID FROM Receita03_ValueData WHERE Value = '" + lbperfil.getText() + "')) RECEITA WHERE  TemplateID = '12'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(query1);
        ...
        try {
            Class.forName(Auxiliar.AcessoBanco.getDriver());
            Connection con = DriverManager.getConnection(Auxiliar.AcessoBanco.getUrl(), Auxiliar.AcessoBanco.getUser(), Auxiliar.AcessoBanco.getPass());
            String query1 = "SELECT * FROM(SELECT ValueID, TemplateID,(Value) as valor2 FROM Receita03_ValueData WHERE ValueID = (SELECT ValueID FROM Receita03_ValueData WHERE Value = '" + lbperfil.getText() + "')) RECEITA WHERE  TemplateID = '8'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(query1);
        ...
        try {
            Class.forName(Auxiliar.AcessoBanco.getDriver());
            Connection con = DriverManager.getConnection(Auxiliar.AcessoBanco.getUrl(), Auxiliar.AcessoBanco.getUser(), Auxiliar.AcessoBanco.getPass());
            String query1 = "SELECT * FROM(SELECT ValueID, TemplateID,(Value) as valor2 FROM Receita03_ValueData WHERE ValueID = (SELECT ValueID FROM Receita03_ValueData WHERE Value = '" + lbperfil.getText() + "')) RECEITA WHERE  TemplateID = '39'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(query1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L01ATBExtrusoraD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
