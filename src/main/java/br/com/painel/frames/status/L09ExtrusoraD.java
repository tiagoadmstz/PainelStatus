 ...
 * @author rsouza10
 */
public class L09ExtrusoraD extends javax.swing.JFrame {

    /**
     * Creates new form L11Extrusora
     */
    public L09ExtrusoraD() {
        initComponents();
            ...
            public void run() {
                try {
                    ...
                    String query1 = "SELECT TOP 1 (ExtD_IndInv1)as inv1ind,(ExtD_SetInv1)as inv1set, (Perfil)as perfil,"
                            ...
                            + "(ExtD_Amp) as extamp,(ExtD_Bar) as extbar,(ExtD_IndRpm) as extindrpm FROM L09 ORDER BY E3TimeStamp DESC";
        ...
        timer1.scheduleAtFixedRate(new TimerTask() {
            public void run() {
                try {
                    Class.forName(Auxiliar.AcessoBanco.getDriver());
                    Connection con = DriverManager.getConnection(Auxiliar.AcessoBanco.getUrl(), Auxiliar.AcessoBanco.getUser(), Auxiliar.AcessoBanco.getPass());
                    String query1 = "SELECT TOP 1 (ExtD_Corrente) as extamp,(ExtD_Pressao) as extbar,(ExtD_RPM) as extindrpm FROM L09_Criticos ORDER BY E3TimeStamp DESC";
                    Statement st = con.createStatement();
                    ResultSet rs = st.executeQuery(query1);
                    float extamp = 0f;
                    float extbar = 0f;
...
/////////////////////////////////////////////////////////////////////////////////////
        try {
            Class.forName(Auxiliar.AcessoBanco.getDriver());
            Connection con = DriverManager.getConnection(Auxiliar.AcessoBanco.getUrl(), Auxiliar.AcessoBanco.getUser(), Auxiliar.AcessoBanco.getPass());
            String query1 = "SELECT * FROM(SELECT ValueID, TemplateID, (Value) as valor1 FROM Receita09_ValueData WHERE ValueID = (SELECT ValueID FROM Receita09_ValueData WHERE Value = '" + lbperfil.getText() + "')) RECEITA WHERE TemplateID = '16'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(query1);
            float valor1 = 0f;
        ...
        try {
            Class.forName(Auxiliar.AcessoBanco.getDriver());
            Connection con = DriverManager.getConnection(Auxiliar.AcessoBanco.getUrl(), Auxiliar.AcessoBanco.getUser(), Auxiliar.AcessoBanco.getPass());
            String query1 = "SELECT * FROM(SELECT ValueID, TemplateID,(Value) as valor2 FROM Receita09_ValueData WHERE ValueID = (SELECT ValueID FROM Receita09_ValueData WHERE Value = '" + lbperfil.getText() + "')) RECEITA WHERE  TemplateID = '20'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(query1);
        ...
        try {
            Class.forName(Auxiliar.AcessoBanco.getDriver());
            Connection con = DriverManager.getConnection(Auxiliar.AcessoBanco.getUrl(), Auxiliar.AcessoBanco.getUser(), Auxiliar.AcessoBanco.getPass());
            String query1 = "SELECT * FROM(SELECT ValueID, TemplateID,(Value) as valor2 FROM Receita09_ValueData WHERE ValueID = (SELECT ValueID FROM Receita09_ValueData WHERE Value = '" + lbperfil.getText() + "')) RECEITA WHERE  TemplateID = '12'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(query1);
        ...
        try {
            Class.forName(Auxiliar.AcessoBanco.getDriver());
            Connection con = DriverManager.getConnection(Auxiliar.AcessoBanco.getUrl(), Auxiliar.AcessoBanco.getUser(), Auxiliar.AcessoBanco.getPass());
            String query1 = "SELECT * FROM(SELECT ValueID, TemplateID,(Value) as valor2 FROM Receita09_ValueData WHERE ValueID = (SELECT ValueID FROM Receita09_ValueData WHERE Value = '" + lbperfil.getText() + "')) RECEITA WHERE  TemplateID = '8'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(query1);
        ...
        try {
            Class.forName(Auxiliar.AcessoBanco.getDriver());
            Connection con = DriverManager.getConnection(Auxiliar.AcessoBanco.getUrl(), Auxiliar.AcessoBanco.getUser(), Auxiliar.AcessoBanco.getPass());
            String query1 = "SELECT * FROM(SELECT ValueID, TemplateID,(Value) as valor2 FROM Receita09_ValueData WHERE ValueID = (SELECT ValueID FROM Receita09_ValueData WHERE Value = '" + lbperfil.getText() + "')) RECEITA WHERE  TemplateID = '39'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(query1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L09ExtrusoraD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new L09ExtrusoraD().setVisible(true);
            }
        });
    }
