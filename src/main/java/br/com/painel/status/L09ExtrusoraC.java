 ...
 * @author rsouza10
 */
public class L09ExtrusoraC extends javax.swing.JFrame {

    /**
     * Creates new form L11Extrusora
     */
    public L09ExtrusoraC() {
        initComponents();
            ...
            public void run() {
                try {
                    ...
                    String query1 = "SELECT TOP 1 (ExtC_IndInv1)as inv1ind,(ExtC_SetInv1)as inv1set, (Perfil)as perfil,"
                            ...
                            + "(ExtC_IndInv3)AS inv3ind,(ExtC_SetInv3)AS inv3set FROM L09 ORDER BY E3TimeStamp DESC";
        ...
        timer1.scheduleAtFixedRate(new TimerTask() {
            public void run() {
                try {
                    Class.forName(Auxiliar.AcessoBanco.getDriver());
                    Connection con = DriverManager.getConnection(Auxiliar.AcessoBanco.getUrl(), Auxiliar.AcessoBanco.getUser(), Auxiliar.AcessoBanco.getPass());
                    String query1 = "SELECT TOP 1 (ExtC_Corrente) as extamp,(ExtC_Pressao) as extbar,(ExtC_RPM) as extindrpm FROM L09_Criticos ORDER BY E3TimeStamp DESC";
                    Statement st = con.createStatement();
                    ResultSet rs = st.executeQuery(query1);
                    float extamp = 0f;
                    float extbar = 0f;
...
/////////////////////////////////////////////////////////////////////////////////////
        try {
            Class.forName(Auxiliar.AcessoBanco.getDriver());
            Connection con = DriverManager.getConnection(Auxiliar.AcessoBanco.getUrl(), Auxiliar.AcessoBanco.getUser(), Auxiliar.AcessoBanco.getPass());
            String query1 = "SELECT * FROM(SELECT ValueID, TemplateID, (Value) as valor1 FROM Receita09_ValueData WHERE ValueID = (SELECT ValueID FROM Receita09_ValueData WHERE Value = '" + lbperfil.getText() + "')) RECEITA WHERE TemplateID = '15'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(query1);
            float valor1 = 0f;
        ...
        try {
            Class.forName(Auxiliar.AcessoBanco.getDriver());
            Connection con = DriverManager.getConnection(Auxiliar.AcessoBanco.getUrl(), Auxiliar.AcessoBanco.getUser(), Auxiliar.AcessoBanco.getPass());
            String query1 = "SELECT * FROM(SELECT ValueID, TemplateID,(Value) as valor2 FROM Receita09_ValueData WHERE ValueID = (SELECT ValueID FROM Receita09_ValueData WHERE Value = '" + lbperfil.getText() + "')) RECEITA WHERE  TemplateID = '19'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(query1);
        ...
        try {
            Class.forName(Auxiliar.AcessoBanco.getDriver());
            Connection con = DriverManager.getConnection(Auxiliar.AcessoBanco.getUrl(), Auxiliar.AcessoBanco.getUser(), Auxiliar.AcessoBanco.getPass());
            String query1 = "SELECT * FROM(SELECT ValueID, TemplateID,(Value) as valor2 FROM Receita09_ValueData WHERE ValueID = (SELECT ValueID FROM Receita09_ValueData WHERE Value = '" + lbperfil.getText() + "')) RECEITA WHERE  TemplateID = '11'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(query1);
        ...
        try {
            Class.forName(Auxiliar.AcessoBanco.getDriver());
            Connection con = DriverManager.getConnection(Auxiliar.AcessoBanco.getUrl(), Auxiliar.AcessoBanco.getUser(), Auxiliar.AcessoBanco.getPass());
            String query1 = "SELECT * FROM(SELECT ValueID, TemplateID,(Value) as valor2 FROM Receita09_ValueData WHERE ValueID = (SELECT ValueID FROM Receita09_ValueData WHERE Value = '" + lbperfil.getText() + "')) RECEITA WHERE  TemplateID = '7'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(query1);
        ...
        try {
            Class.forName(Auxiliar.AcessoBanco.getDriver());
            Connection con = DriverManager.getConnection(Auxiliar.AcessoBanco.getUrl(), Auxiliar.AcessoBanco.getUser(), Auxiliar.AcessoBanco.getPass());
            String query1 = "SELECT * FROM(SELECT ValueID, TemplateID,(Value) as valor2 FROM Receita09_ValueData WHERE ValueID = (SELECT ValueID FROM Receita09_ValueData WHERE Value = '" + lbperfil.getText() + "')) RECEITA WHERE  TemplateID = '22'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(query1);
        ...
        try {
            Class.forName(Auxiliar.AcessoBanco.getDriver());
            Connection con = DriverManager.getConnection(Auxiliar.AcessoBanco.getUrl(), Auxiliar.AcessoBanco.getUser(), Auxiliar.AcessoBanco.getPass());
            String query1 = "SELECT * FROM(SELECT ValueID, TemplateID,(Value) as valor2 FROM Receita09_ValueData WHERE ValueID = (SELECT ValueID FROM Receita09_ValueData WHERE Value = '" + lbperfil.getText() + "')) RECEITA WHERE  TemplateID = '38'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(query1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L09ExtrusoraC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new L09ExtrusoraC().setVisible(true);
            }
        });
    }
